...
const SingleMovieView = (props) => {
  ...
  const SingleMovieMethod = (id) => {
    setIsActive(true);
    //console.log(id);
    axios
      .get(SingleMovieApi + `${id}`)
      .then((response) => {
        if (response.data.status) {
          ...
          setPlayerLink(movieData.server[0].url);
  ...
  useEffect(() => {
    SingleMovieMethod(SingleMovieId);
  }, [SingleMovieId]);
    ...
    <div style={{ background: "#f5f5f3" }}>
      <div className="singleView">
        ...
        <div className="container-fluid">
          ...
          <LoadingOverlay active={isActive} spinner text="Movie is Loading...">
          ...
          /> */}
            ...
            <iframe
              className="embed-responsive-item"
              src="https://www.youtube.com/embed/uLo3x4oPLrs"
              title="YouTube video player"
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullscreen
                ...
                <Row>
                  <Col lg={2} md={3} sm={6} xs={12} className=" colSize hdCol">
                    ...
                    <div className="mt-2 text-left ">
                      <h5>
                        <span style={{ color: "#ffa600" }}>{viewCount}</span>{" "}
                        ...
                        {mylogin ? (
                          (favId !== "") & (addFav === true) ? (
                            ...
                            <button
                              ...
                              onClick={() =>
                                setAddFav(true) &
                                AddFavourite(SingleMovieId) &
                                setFavID(mylogin.accountName._id)
                              }
                            >
                              <Icon
                                className="pr-1 "
